...
The dataset contains Electric Vehicle sales records across multiple Indian states, vehicle categories, classes, and vehicle types.
...
![Electric Vehicle Sales Dashboard](Electric_vech_analysis1.png)
## 📌 Conclusion
